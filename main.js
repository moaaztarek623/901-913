...
input_2.oninput = function () {
    ...
    if (input_2.value == arrayOfChars[1]) {
        code_2.innerHTML = '902'
    }
    if (input_2.value == arrayOfChars[2]) {
        code_2.innerHTML = '903'
    }
    if (input_2.value == arrayOfChars[3]) {
        code_2.innerHTML = '904'
    }
    if (input_2.value == arrayOfChars[4]) {
        code_2.innerHTML = '905'
    }
    if (input_2.value == arrayOfChars[5]) {
        code_2.innerHTML = '906'
    }
    if (input_2.value == arrayOfChars[6]) {
        code_2.innerHTML = '907'
    }
    if (input_2.value == arrayOfChars[7]) {
        code_2.innerHTML = '908'
    }
    if (input_2.value == arrayOfChars[9]) {
        code_2.innerHTML = '910'
    }
    if (input_2.value == arrayOfChars[10]) {
        code_2.innerHTML = '911'
    }
    if (input_2.value == arrayOfChars[11]) {
        code_2.innerHTML = '912'
    }
    if (input_2.value == arrayOfChars[12]) {
        code_2.innerHTML = '913'
    }
    if (input_2.value == arrayOfChars[13]) {
        code_2.innerHTML = '914'
    }
    if (input_2.value == arrayOfChars[14]) {
        code_2.innerHTML = '915'
    }
    if (input_2.value == arrayOfChars[15]) {
        code_2.innerHTML = '916'
    }
    if (input_2.value == arrayOfChars[16]) {
        code_2.innerHTML = '917'
    }
    if (input_2.value == arrayOfChars[17]) {
        code_2.innerHTML = '918'
    }
    if (input_2.value == arrayOfChars[18]) {
        code_2.innerHTML = '919'
    }
    if (input_2.value == arrayOfChars[19]) {
        code_2.innerHTML = '920'
    }
    if (input_2.value == arrayOfChars[20]) {
        code_2.innerHTML = '921'
    }
    if (input_2.value == arrayOfChars[21]) {
        code_2.innerHTML = '922'
    }
    if (input_2.value == arrayOfChars[22]) {
        code_2.innerHTML = '923'
    }
    if (input_2.value == arrayOfChars[23]) {
        code_2.innerHTML = '924'
    }
    if (input_2.value == arrayOfChars[24]) {
        code_2.innerHTML = '925'
    }
    if (input_2.value == arrayOfChars[25]) {
        code_2.innerHTML = '926'
    }
}
